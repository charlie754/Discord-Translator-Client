    ...
    return (
        <section className={Margins.top16}>
            ...
            <Paragraph className={Margins.bottom8}>
                Settings for Notifications sent by Discord Translator.
    ...
    return (
        <>
            ...
            <Paragraph className={Margins.bottom8}>
                ...
                <ul>
                    <li><strong>Discord Translator Notifications</strong>: These are in-app notifications</li>
            ...
            <Select
                ...
                options={[
                    ...
                    { label: "Always use Discord Translator notifications", value: "never" },
