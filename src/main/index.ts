        ...
        try {
            if (RendererSettings.store.enableReactDevtools)
                installExt("fmkadmapgofadopljbjfkapdkoienihi")
                    .then(() => console.info("[Discord Translator] Installed React Developer Tools"))
                    .catch(err => console.error("[Discord Translator] Failed to install React Developer Tools", err));
        } catch { }
